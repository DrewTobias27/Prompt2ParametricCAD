...
result predates package v12. The August 13 v12 regression now collects 668 Python
test cases with all 15 installed-API compile/setup cases passing, all six frontend
