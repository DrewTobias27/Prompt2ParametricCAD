...
and double-click `Build-SolidWorks-Part.cmd`.
...
4. Confirm the package-v12 result reports `reopened: true`, exact verified
...
powershell.exe -NoProfile -ExecutionPolicy Bypass `
  ...
  -DownloadedPackagePath "C:\Users\you\Downloads\part-v12-solidworks.zip" `
  -Visible
```
...
result predates package v12. The August 13 v12 regression now collects 675 Python
test cases with all 16 installed-API compile/setup cases passing, all six frontend
