...
result predates package v10. The August 13 v10 regression now passes 624 Python
tests with all nine compile-only C# contract probes enabled, all six frontend
