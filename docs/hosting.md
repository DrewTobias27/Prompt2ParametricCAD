...
result predates package v10. The August 13 v10 regression now passes 638 Python
test cases with all 13 installed-API compile/setup cases enabled, all six frontend
