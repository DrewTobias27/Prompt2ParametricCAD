...
result predates package v10. The August 13 v10 regression now passes 636 Python
tests with all eleven compile-only C# contract probes enabled, all six frontend
