...
@pytest.mark.parametrize(
    ...
    [
        ...
        },
        {
            ...
            "segments": [
                {"type": "line", "to": [10, -10]},
                {"type": "arc", "through": [20, 0], "to": [10, 10]},
                {"type": "line", "to": [-10, 10]},
            ],
            "close": True,
            "distance": 6,
        ...
        },
        {
            ...
            "start": [0, -30],
            "segments": [
                {"type": "arc", "through": [5, -28.660254], "to": [10, -20]},
                {"type": "line", "to": [10, 20]},
                {"type": "arc", "through": [5, 28.660254], "to": [0, 30]},
                {"type": "line", "to": [0, -30]},
            ],
            "close": True,
            "axis_start": [0, -1],
